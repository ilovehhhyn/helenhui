...
(function () {
    ...
    function injectStyles() {
        ...
        var css = [
            ...
            "  .writings-summary {",
            "    display: inline-block; color: #000000; border: 1px solid #000000;",
            "    padding: 8px 16px; border-radius: 20px; cursor: pointer;",
            "    font-family: Arial, sans-serif; font-size: 0.85em;",
            "    letter-spacing: 0.05em; user-select: none;",
            "    background-color: #ffffff; transition: background-color 0.2s, color 0.2s;",
            "  }",
            ...
            "  .writings-links a {",
            "    color: #000000; text-decoration: none; font-family: Arial, sans-serif;",
            "    font-size: 0.85em; line-height: 1.4; text-align: right;",
            "    border-bottom: 1px solid #000000; padding-bottom: 6px;",
            "  }",
            "  .writings-links a:last-child { border-bottom: none; padding-bottom: 0; }",
            "  .writings-links a:hover { color: #000000; }",
            "}"
        ].join("\n");
